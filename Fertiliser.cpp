...
Fertiliser::Fertiliser(){
    ...
    equip_value = 0; // The value of the equipment increases as you upgrade
}

// returns a short description with multiplier value depending on the upgrade level of the fertiliser
